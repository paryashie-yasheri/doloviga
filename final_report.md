...
Университет: ___________________________
Факультет/кафедра: ______________________
Дисциплина: _____________________________

Отчет по проекту: "Doloviga"
Тема: Настольные часы с визуализацией окружающих звуков

Команда: SoaringLizards
Исполнители: ____________________________
...
6. Описание хода выполнения работы
  ...
  - Вклад участников
    - Аппаратная часть: выбор и подключение микрофона, дисплея, датчика, питание.
    - Встроенное ПО: драйверы I2S/SPI, обработка аудио, отображение UI, Bluetooth-протокол.
    - Мобильный клиент: сканирование/подключение, синхронизация времени, настройки интерфейса.
