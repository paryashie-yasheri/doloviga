...
7. Описание результатов проведенной работы
  ...
  - Перспективы развития:
    - Разработка DSL + интерпретатор для описания интерфейса, чтобы пользователь сам мог создавать дизайны
    - Имплементирование более кастомную настройку умных часов с мобильного приложения
